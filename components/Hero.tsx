...
function Hero() {
  ...
  return (
    <section className='py-14 flex flex-col items-center gap-5 lg:gap-1 bg-[#000]'>
        <h1 className='text-3xl sm:text-4xl md:text-5xl font-bold text-[#f2f2f7]'>MacBook Pro</h1>
        ...
        <p className='text-sm'>From $1599 or $133/mo for 12 months</p>
    </section>
  )
}
